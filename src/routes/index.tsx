      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow">
        <header className="mb-4 text-center relative">
          ...
          <a
            ...
            className="absolute top-0 left-0 inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 focus:bg-gray-200 transition-colors"
